...
public class CustomerCreatedEventHandlerTest
{
    ...
    public void Handle_CustomerObjectFilled_Success()
    {
        ...
        var customer = dpTest.GetDomainEventObject<Domain.Aggregates.Customer.Customer>(customerCreated);
        var customerCreatedEventHandler = new Application.EventHandlers.Customer.CustomerCreatedEventHandler(null, dpTest.MockDp<ICustomerState>(null));
