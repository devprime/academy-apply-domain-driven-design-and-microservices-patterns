...
{
    public static Guid FixedID = new Guid("e382d322-ffe7-420e-8af5-024e011a6069");
...
#region fixtures
    public static Domain.Aggregates.Customer.Customer Create_Customer_Required_Properties_OK(DpTest dpTest)
    {
        ...
        dpTest.Set<string>(customer, "TaxID", Faker.Lorem.Sentence(1));
    ...
    public static Domain.Aggregates.Customer.Customer Create_Customer_With_TaxID_Required_Property_Missing(DpTest dpTest)
    {
        var customer = new Domain.Aggregates.Customer.Customer();
        dpTest.MockDpDomain(customer);
        dpTest.Set<Guid>(customer, "ID", FixedID);
...
#region add
    ...
    public void Add_TaxID_Missing_Fail()
    {
        //Arrange
        var dpTest = new DpTest();
        var customer = Create_Customer_With_TaxID_Required_Property_Missing(dpTest);
        //Act and Assert
        var ex = Assert.Throws<PublicException>(customer.Add);
        Assert.Equal("Public exception", ex.ErrorMessage);
