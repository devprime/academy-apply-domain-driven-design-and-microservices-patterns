...
public class Customer
{
    ...
    public Application.Services.Customer.Model.Email Email { get; set; }
    ...
    public static Application.Services.Customer.Model.Customer ToApplication(Domain.Aggregates.Customer.Customer customer)
    {
        ...
        _customer.Email = Application.Services.Customer.Model.Email.ToApplication(customer.Email);
    ...
    public static Domain.Aggregates.Customer.Customer ToDomain(Application.Services.Customer.Model.Customer customer)
    {
        ...
        Domain.Aggregates.Customer.Customer _customer = new Domain.Aggregates.Customer.Customer(customer.ID, Application.Services.Customer.Model.Email.ToDomain(customer.Email), customer.Name);
        return _customer;
    }
