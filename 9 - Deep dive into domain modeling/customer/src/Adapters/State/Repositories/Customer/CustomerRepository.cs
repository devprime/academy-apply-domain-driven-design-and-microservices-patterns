...
#region mappers
    public static DevPrime.State.Repositories.Customer.Model.Customer ToState(Domain.Aggregates.Customer.Customer customer)
    {
        ...
        _customer.Email = ToState(customer.Email);
        _customer.Name = customer.Name;
        return _customer;
    }
    public static DevPrime.State.Repositories.Customer.Model.Email ToState(Domain.Aggregates.Customer.Email email)
    {
        if (email is null)
            return new DevPrime.State.Repositories.Customer.Model.Email();
        DevPrime.State.Repositories.Customer.Model.Email _email = new DevPrime.State.Repositories.Customer.Model.Email();
        _email.Value = email.Value;
        return _email;
    }
    public static List<DevPrime.State.Repositories.Customer.Model.Email> ToState(IList<Domain.Aggregates.Customer.Email> emailList)
    {
        List<DevPrime.State.Repositories.Customer.Model.Email> _emailList = new List<DevPrime.State.Repositories.Customer.Model.Email>();
        if (emailList != null)
        {
    ...
    public static Domain.Aggregates.Customer.Customer ToDomain(DevPrime.State.Repositories.Customer.Model.Customer customer)
    {
        if (customer is null)
            ...
            {IsNew = true};
        Domain.Aggregates.Customer.Customer _customer = new Domain.Aggregates.Customer.Customer(customer.ID, ToDomain(customer.Email), customer.Name);
        return _customer;
    }
    public static Domain.Aggregates.Customer.Email ToDomain(DevPrime.State.Repositories.Customer.Model.Email email)
    {
        if (email is null)
    ...
    public static List<Domain.Aggregates.Customer.Email> ToDomain(IList<DevPrime.State.Repositories.Customer.Model.Email> emailList)
    {
