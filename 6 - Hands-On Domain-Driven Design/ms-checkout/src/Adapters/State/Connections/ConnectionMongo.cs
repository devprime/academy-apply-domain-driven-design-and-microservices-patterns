...
public class ConnectionMongo : MongoBaseState
{
    ...
    public IMongoCollection<DevPrime.State.Repositories.PromoCode.Model.PromoCode> PromoCode
    {
        get
        {
            return Db.GetCollection<DevPrime.State.Repositories.PromoCode.Model.PromoCode>("PromoCode");
        }
    }
}